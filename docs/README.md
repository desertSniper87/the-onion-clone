...
4. [Algorithms](4-algorithms/README.md) - Core logic for scraping and satire generation.
5. [API](5-api/README.md) - Backend API documentation.
6. [Deployment](6-deployment/README.md) - Hosting and infrastructure.
